...
import perfecto_home from "@/assets/images/perfecto_home.png";
...
const HERO_CARDS: HeroCard[] = [
  ...
  {
    activeSrc: "https://i.ibb.co.com/kgRd6hG7/Gemini-Generated-Image-9hg43s9hg43s9hg4.png",
    left: "left-[96px]",
    webLink: "www.knockmyride.com"
  },
  {
    activeSrc: "https://i.ibb.co.com/jvXLdHTG/wedding-House.png",
    left: "left-[128px]",
    webLink: "www.knockmyride.com"
  },
  {
    activeSrc: "https://i.ibb.co.com/k2262kgD/Gemini-Generated-Image-9kkgkw9kkgkw9kkg.png",
    left: "left-[160px]",
    showIdleSwap: false,
    className: "transition-opacity duration-300",
    webLink: "https://perfectobd.com"
  },
];
              ...
              return (
                <motion.div
                  ...
                  onClick={() => {
                    ...
                    const url = getAbsoluteUrl(card.webLink);
                    if (url) {
