...
export const Icons = {
  ...
  <svg
    ...
    className="w-6 h-6"
  >
    <path d="M12 4a4 4 0 0 1 3.5 6A4 4 0 0 1 12 14a4 4 0 0 1-3.5-6A4 4 0 0 1 12 4z" />
    <path d="M12 14v6" />
    <path d="M10 18h4" />
...
const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  const [generatedDuration] = useState(() => Math.random() * 3 + 4);
  const animationDuration = duration ?? generatedDuration;
